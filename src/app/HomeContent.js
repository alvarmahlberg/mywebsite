...
export default function HomeContent() {
  ...
  const writings = [
    {
      ...
      date: 'March 2026',
      href: '/writing/what-cc0-actually-unlocks',
    },
    {
      title: 'When generative artists get access to a national archive',
      date: 'February 2026',
      href: '/writing/generative-art-national-archive',
    },
    {
      title: 'Algorithm Is the Artwork',
      date: 'February 2026',
      href: '/writing/museums-reaching-for-new-audiences',
    },
    {
      title: 'What we learned from selling generative art on-chain',
      date: 'February 2026',
      href: '/writing/selling-generative-art-on-chain',
    },
    {
      title: 'Example Article',
      date: 'February 2026',
      href: '/writing/example-article',
    },
    {
      title: 'Second Article',
      date: 'February 2026',
      href: '/writing/second-article',
    },
  ];
  ...
  return (
    <div className="flex flex-col items-center pt-8">
      <div className="w-[90%] md:w-[1000px] px-4 md:px-6 pb-12 md:pb-16">
